const _meta = {
  ...
  "version": 1,
  "icon": "mdi:less-than",
  "description": "Tests whether the left JSON scalar is less than the right scalar.",
  "summary": "{{left}} less than {{right}}",
  "targets": [
    "backend",
    "frontend",
  ],
  ...
  "properties": {
    "left": {
      ...
      "kind": "value",
      "type": "unknown",
      "description": "Scalar value tested as less than the right operand.",
    },
    "right": {
      "label": "Right",
      "kind": "value",
