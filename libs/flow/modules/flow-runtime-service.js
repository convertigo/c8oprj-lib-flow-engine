(function () {
	function create(env) {
		...
		var isRuntimeHandle = env.isRuntimeHandle;
		var runtimeHandleSummary = env.runtimeHandleSummary;
		var createRuntimeHandle = env.createRuntimeHandle;
		var runtimeHandleValue = env.runtimeHandleValue;
		var closeRuntimeHandle = env.closeRuntimeHandle;
